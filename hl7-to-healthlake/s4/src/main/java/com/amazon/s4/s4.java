...
public class s4 {
    ...
    public static class Builder {
        ...
        public Builder queryParametes(String strQueryParametes) {
            //FORMAT OF INPUT STRING MUST BE
            //String strQueryParametes = "1=ONE,2=TWO,3=THREE,4=FOUR"; // consider the input with , delimited KeyValuePairs
            TreeMap <String,String> queryParametes = new TreeMap<>();
            List<String> pairs = Arrays.asList(strQueryParametes.split(",")); // Split the String into list of Pairs
		
		for(String entry : pairs) // loop through the pairs
            {
                String[] pair = entry.split("="); // Split the entry into Key and Value
                
                queryParametes.put(pair[0], pair[1]); // Add the key & value to TreeMap.
            }
            this.queryParametes = queryParametes;
            return this;
        }
        ...
        public Builder awsHeaders(String strAwsHeaders) {
            //FORMAT OF INPUT STRING MUST BE
            //String strAwsHeaders = "1=ONE,2=TWO,3=THREE,4=FOUR"; // consider the input with , delimited KeyValuePairs
            TreeMap <String,String> awsHeaders = new TreeMap<>();
            List<String> pairs = Arrays.asList(strAwsHeaders.split(",")); // Split the String into list of Pairs
		
		for(String entry : pairs) // loop through the pairs
            {
                String[] pair = entry.split("="); // Split the entry into Key and Value
                
                awsHeaders.put(pair[0], pair[1]); // Add the key & value to TreeMap.
            }
            this.awsHeaders = awsHeaders;
            return this;
        }
